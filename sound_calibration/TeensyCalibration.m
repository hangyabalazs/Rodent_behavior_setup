...
%                               What you need:
%
% Working Bpod (https://sanworks.io/shop/viewproduct?productID=1001)
% TrueRTA software (https://www.trueaudio.com/rta_down.htm) Download and
% install the free version. If you already posess another similar software
% that reads dB SPL from a microphone you can use it instead (edit the code
% accordingly). Calibrated microphone (set it as input device for TrueRTA)
% Teensy with
% Audioboard*(https://sites.google.com/site/bpoddocumentation/bpod-user-guide/function-reference/teensysoundserver)
%
%                               Instructions:
%
% This protocol will create calibrated pure tones from 1kHz to 21kHz.
% At the beginning you will be asked the frequency resolution to adopt in this
% range to create your audio files:
%     -1kHz  to produce 1kHz, 2kHz, 3kHz, etc.. sinewaves
%     -0.5Khz  to produce 1kHz, 1.5kHz,  2kHz, 2.5kHz, 3kHz, etc..
%     sinewaves
%     -0.25kHz  to produce 1kHz, 1.25kHz, 1.5kHz, 1.75kHz,
%     2kHz, 2.25kHz, 2.5kHz, etc.. sinewaves
% The program will therefore load the corresponding audio files, create a
% dedicated xlsx and open TrueRTA. You will read live the dB SPL value
% generated by every pitch played: this should be written in the xlsx. Each
% dB SPL should be written in the cell below the corresponding frequency
% listed in the first row of the table. The tone will be played using the
% Bpod interface.
% LED2 will turn on: after 1 second, a pitch will be reproduced.
% Once the sound is played, click on Port3 to proceed with the next
% or Port1 to play it again. When done, save and close the xlsx. This will be
% repeated twice to have an accurate calibration. Finally, you will have
% also the option to create an almost equalised white noise track
% following a similar procedure.
% Dialogue boxes will lead you through the process.
%
% * Please control audioShield.volume value in the TeensySoundServer
% Arduino file. Our setting was 0.5.
%
% N.B. Before launching the protocol, you shopuld edit the Bpod file TeensySoundServer.m.
%   -line 26    varargin argument is 2 insted than 1
%   -line 27    set Timeout value to 20 insted than 1
%   -line 33    in the path substitute 'Bpod System Files' with 'Functions' (this only in the new version)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
